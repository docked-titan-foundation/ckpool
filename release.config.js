...
const plugins = [
  [
    ...
    {
      // Release triggering is scope-gated: only `ckpool` (upstream source bumps)
      // and `dependencies` (Dockerfile deps, e.g. the Debian base image) can cut a
      // release. Everything else — hand-written feats, unscoped commits — is
